    ...
    render() {
        ...
        return (
            <Grid container className={classes.root}>
                <Button className={classes.center}>{this.loggedIn
                    ? <Link component={RouterLink} variant="body1" to="/login">Logout</Link> 
                    : <Link component={RouterLink} variant="body1" to="/login">Login</Link>}
                </Button>
                            ...
                            <Grid item>   
                                <Paper className={classes.root}>
                                    ...
                                    <section className={ classes.section }>
                                        <SubmitDialog handleCreate={addTask}/>
                                        <TablePagination
                                            rowsPerPageOptions={[]}
                                            component="div"
